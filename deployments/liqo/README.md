...
| controllerManager.image.name | string | `"ghcr.io/castai/images/liqo/liqo-controller-manager"` | Image repository for the controller-manager pod. |
...
| crdReplicator.image.name | string | `"ghcr.io/castai/images/liqo/crd-replicator"` | Image repository for the crdReplicator pod. |
...
| ipam.internal.image.name | string | `"ghcr.io/castai/images/liqo/ipam"` | Image repository for the IPAM pod. |
...
| liqo-crds.crdUpgrade.image.name | string | `"ghcr.io/castai/images/liqo/liqo-crd-upgrade"` | Image repository for the CRD upgrade job. NOTE: This image only supports linux/amd64 and linux/arm64 platforms (arm/v7 is not supported). |
...
| metricAgent.image.name | string | `"ghcr.io/castai/images/liqo/metric-agent"` | Image repository for the metricAgent pod. |
| metricAgent.image.version | string | `""` | Custom version for the metricAgent image. If not specified, the global tag is used. |
| metricAgent.initContainer.image.name | string | `"ghcr.io/castai/images/liqo/cert-creator"` | Image repository for the init container of the metricAgent pod. |
...
| networking.fabric.config.multipathHashPolicy | bool | `true` | Enable 5-tuple ECMP hashing (fib_multipath_hash_policy=1) in the fabric pod. This improves load balancing when multiple gateway replicas provide ECMP next-hops. |
...
| networking.fabric.image.name | string | `"ghcr.io/castai/images/liqo/fabric"` | Image repository for the fabric pod. |
...
| networking.gatewayTemplates | object | `{"container":{"gateway":{"extraArgs":[],"image":{"name":"ghcr.io/castai/images/liqo/gateway","version":""},"resources":{"limits":{},"requests":{}}},"geneve":{"image":{"name":"ghcr.io/castai/images/liqo/gateway/geneve","version":""},"resources":{"limits":{},"requests":{}}},"wireguard":{"image":{"name":"ghcr.io/castai/images/liqo/gateway/wireguard","version":""},"resources":{"limits":{},"requests":{}}}},"nftablesMonitor":true,"ping":{"interval":"2s","lossThreshold":5,"updateStatusInterval":"10s"},"pod":{"affinity":{},"annotations":{},"nodeSelector":{},"priorityClassName":"","tolerations":[]},"routeMonitor":true,"server":{"service":{"allocateLoadBalancerNodePorts":"","annotations":{}}},"wireguard":{"implementation":"kernel","preserveClientEndpoint":true}}` | Set the options for the default gateway (server/client) templates. The default templates use a WireGuard implementation to connect the gateway of the clusters. These options are used to configure only the default templates and should not be considered if a custom template is used. |
| networking.gatewayTemplates.container.gateway.extraArgs | list | `[]` | Extra arguments for the gateway container. |
| networking.gatewayTemplates.container.gateway.image.name | string | `"ghcr.io/castai/images/liqo/gateway"` | Image repository for the gateway container. |
...
| networking.gatewayTemplates.container.geneve.image.name | string | `"ghcr.io/castai/images/liqo/gateway/geneve"` | Image repository for the geneve container. |
...
| networking.gatewayTemplates.container.wireguard.image.name | string | `"ghcr.io/castai/images/liqo/gateway/wireguard"` | Image repository for the wireguard container. |
...
| offloading.reflection.localstoragepvc.type | string | `"DenyList"` | The type of reflection used for the pvc mapped on local storage reflector. Ammitted values: "DenyList", "AllowList". |
...
| proxy.image.name | string | `"ghcr.io/castai/images/liqo/proxy"` | Image repository for the proxy pod. |
...
| telemetry.image.name | string | `"ghcr.io/castai/images/liqo/telemetry"` | Image repository for the telemetry pod. |
...
| uninstaller.image.name | string | `"ghcr.io/castai/images/liqo/uninstaller"` | Image repository for the uninstaller pod. |
...
| virtualKubelet.image.name | string | `"ghcr.io/castai/images/liqo/virtual-kubelet"` | Image repository for the virtual kubelet pod. |
...
| webhook.image.name | string | `"ghcr.io/castai/images/liqo/webhook"` | Image repository for the webhook pod. |
