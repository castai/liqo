...
| networking.fabric.config.multipathHashPolicy | bool | `false` | Enable 5-tuple ECMP hashing (fib_multipath_hash_policy=1) in the fabric pod. This improves load balancing when multiple gateway replicas provide ECMP next-hops. |
