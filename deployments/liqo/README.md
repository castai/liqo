...
| controllerManager.image.name | string | `"ghcr.io/castai/images/liqo-controller-manager"` | Image repository for the controller-manager pod. |
...
| crdReplicator.image.name | string | `"ghcr.io/castai/images/crd-replicator"` | Image repository for the crdReplicator pod. |
...
| ipam.internal.image.name | string | `"ghcr.io/castai/images/ipam"` | Image repository for the IPAM pod. |
...
| liqo-crds.crdUpgrade.image.name | string | `"ghcr.io/castai/images/liqo-crd-upgrade"` | Image repository for the CRD upgrade job. NOTE: This image only supports linux/amd64 and linux/arm64 platforms (arm/v7 is not supported). |
...
| metricAgent.image.name | string | `"ghcr.io/castai/images/metric-agent"` | Image repository for the metricAgent pod. |
| metricAgent.image.version | string | `""` | Custom version for the metricAgent image. If not specified, the global tag is used. |
| metricAgent.initContainer.image.name | string | `"ghcr.io/castai/images/cert-creator"` | Image repository for the init container of the metricAgent pod. |
...
| networking.fabric.image.name | string | `"ghcr.io/castai/images/fabric"` | Image repository for the fabric pod. |
...
| networking.gatewayTemplates.container.geneve.image.name | string | `"ghcr.io/castai/images/gateway/geneve"` | Image repository for the geneve container. |
...
| networking.gatewayTemplates.container.wireguard.image.name | string | `"ghcr.io/castai/images/gateway/wireguard"` | Image repository for the wireguard container. |
...
| proxy.image.name | string | `"ghcr.io/castai/images/proxy"` | Image repository for the proxy pod. |
...
| telemetry.image.name | string | `"ghcr.io/castai/images/telemetry"` | Image repository for the telemetry pod. |
...
| uninstaller.image.name | string | `"ghcr.io/castai/images/uninstaller"` | Image repository for the uninstaller pod. |
...
| virtualKubelet.image.name | string | `"ghcr.io/castai/images/virtual-kubelet"` | Image repository for the virtual kubelet pod. |
...
| webhook.image.name | string | `"ghcr.io/castai/images/webhook"` | Image repository for the webhook pod. |
