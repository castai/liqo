...
var _ = Describe("NamespaceMapEventHandler tests", func() {
	...
	Describe("IsNamespaceMapped", func() {
		createNamespaceMap := func(mapping map[string]offloadingv1beta1.RemoteNamespaceStatus) {
		...
		When("a NamespaceMap is present", func() {
			BeforeEach(func() {
				createNamespaceMap(map[string]offloadingv1beta1.RemoteNamespaceStatus{
