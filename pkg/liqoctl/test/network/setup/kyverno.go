...
const (
	...
	// podAntiaffinityPolicyName is the base name of the pod anti-affinity Kyverno policy.
	podAntiaffinityPolicyName = "pod-antiaffinity"
)
...
func CreatePolicy(ctx context.Context, cl *client.Client, opts *flags.Options) error {
	names := []string{podAntiaffinityPolicyName, podAntiaffinityPolicyName + "-host"}
...
func ForgeKyvernoPodAntiaffinityPolicy(suffix string, hostnetwork bool) *unstructured.Unstructured {
	...
	name := podAntiaffinityPolicyName
	if hostnetwork {
