...
// CheckAlreadyEstablishedForGwServer checks if any GatewayServer is already established.
func (c *Cluster) CheckAlreadyEstablishedForGwServer(ctx context.Context) (bool, error) {
	...
	return len(gwServerList.Items) > 0, nil
}

// CheckAlreadyEstablishedForGwClient checks if any GatewayClient is already established.
func (c *Cluster) CheckAlreadyEstablishedForGwClient(ctx context.Context) (bool, error) {
	...
	return len(gwClientList.Items) > 0, nil
}
