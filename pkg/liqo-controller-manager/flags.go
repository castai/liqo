...
func InitFlags(flagset *pflag.FlagSet, opts *Options) {
	...
	flagset.BoolVar(&opts.EBPFOverlayEnabled, "enable-ebpf-overlay-mode", false,
		"Enable the eBPF overlay PoC datapath; disables legacy fabric route/firewall controllers")
